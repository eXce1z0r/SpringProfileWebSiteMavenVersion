		...
		<div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
			...
			<main role="main" class="inner cover">
				<form action="register" method="POST" class="form-signin">
					...
					<label for="inputAccountName" class="sr-only">Account name</label>
					<input type="text" name="inputAccountName" id="inputAccountNameID" class="form-control" placeholder="Account name" required autofocus>
					...
					<input type="text" name="inputUserSurname" id="inputUserSurnameID" class="form-control" placeholder="User surname" required autofocus>
					<label for="inputUserPatronymic" class="sr-only">Patronymic</label>
					<input type="text" name="inputUserPatronymic" id="inputUserPatronymicID" class="form-control" placeholder="User patronymic" required autofocus>
